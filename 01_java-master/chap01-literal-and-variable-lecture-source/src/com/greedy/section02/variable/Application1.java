...
public class Application1 {
	public static void main(String[] args) {
		...
		/* 10명의 고객에게 100포인트를 지급해 주는 내용을 출력하도록 작성해 보자. */
		...
		/*
		 * 만약 포인트가 바뀐다면 위의 코드는 10번의 실수 없는 수정 작업을 거쳐야 한다.
		 * 근데 이게 100줄의 코드에 있어서 포인트를 수정한다면 1000번을 실수 없이 수정해야 하는 것이다.
		 * 따라서 우리는 변수를 써서 편하게 같은 값을 실수 없이 활용하고, 수정할 수 있다. 
		 */
		
		/* 3. 상황에 따라 변경되는 값을 저장하고 사용할 수 있다. */
		System.out.println("========== 변수에 저장 되는 값 변경 테스트 ===========");
