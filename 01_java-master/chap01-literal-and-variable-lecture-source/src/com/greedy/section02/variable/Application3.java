...
public class Application3 {
	public static void main(String[] args) {
		 ...
		 * 실부적으로는 굉장히 중요하기 때문에 반드시 숙지해야 하고,
		 * 또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍(코딩)을 위한 첫 단추이다.
		 */
...
//		int 1age = 20;		// 숫자로 처음 시작해서 에러 발생
		int age1 = 20;		// 숫자로 처음에만 시작하지 않으면 섞어 써도 무방
...
//		int sh@rp = 20;		// '@'는 에러 발생
		...
		int fdsafjdkslqerperfsdjaklgfsdangklsdarjfedklrsdfdsafdsafdqwwer;	// 적당히 쓰자.
		
		int maxAge = 80;		// 합성어(단어 두 개 이상)일 경우 낙타봉 표기법 사용(camel-case)
		int minAge = 11;
		
		String user_name;		// 가급적 쓰기 말자
		String userName;
