...
public class Application {
	public static void main(String[] args) {
		 ...
		 * 
		 * Circle has a Point. (o)      연관관계: Circle - Point(필드 변수)
