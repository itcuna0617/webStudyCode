...
//		System.out.println("10번째 학생의 이름은 " + student10 + "입니다.");
		...
		/*
		 * 반복문이 더 좋은 이유
		 * 1. 반복의 횟수가 늘어날수록 for문을 활용한 코드가 작성 시간이 훨씬 적다.(시간절약)
		 * 2. 반복되는 부분을 보기 좋고 간결한 코드가 되게 작성할 수 있다.(가독성)
