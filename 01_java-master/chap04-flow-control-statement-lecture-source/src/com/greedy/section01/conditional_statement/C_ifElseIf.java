...
public class C_ifElseIf {
	public static void testSimpleIfElseIfStatement() {
		...
		if(answer == 1) {
			...
			System.out.println("넌 보기에 없는 답을 하였구나...");
		}
	...
	public static void testNestedIfElseIfStatement() {
		 ...
		 * 경우에는 'F'를 학점 등급으로 하는 기준이다. 추가로 각 등급의 중간점수(95, 85, 75, 65)이상인
...
//			'A'학점 부여;
//		} 그렇지 않고(입력받은 점수가 90점 미만이면서 80점 이상이면) {
//			'B'학점 부여;
//		} 그렇지 않고(입력받은 점수가 80점 미만이면서 70점 이상이면) {
//			'C'학점 부여;
//		} 그렇지 않고(입력받은 점수가 70점 미만이면서 60점 이상이면) {
//			'D'학점 부여;
//		} 그렇지 않다면 {		// 60점 미만이면
//			'F'학점 부여;
//		}
		...
		String grade = "";	    // 지역변수는 왠만하면 선언과 동시에 초기화를 하자
	...
	public static void improveNestedIfElseIfStatement() {
		
		/* testNestedIfElseIfStatement() 메소드와 같은 문제를 좀 더 짧고 효율적인 코드로 풀어보자.(완성도를 높이자) */
		Scanner sc = new Scanner(System.in);
		System.out.print("학생의 이름을 입력하세요: ");
		String name = sc.nextLine();
		System.out.print("학생의 점수를 입력하세요: ");
