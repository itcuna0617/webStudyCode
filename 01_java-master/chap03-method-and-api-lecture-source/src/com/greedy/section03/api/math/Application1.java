...
public class Application1 {
	public static void main(String[] args) {
		...
		/* java.lang.Math */
		/* Math 클래스는 수학에서 자주 사용하는 상수들과 메소드(함수)들을 미리 구현해 놓은 클래스이다. */
		
		/* 절대값 */
//		System.out.println("-7의 절대값: " + java.lang.Math.abs(-7));
		System.out.println("-7의 절대값: " + Math.abs(-7));	// 유일하게 java.lang 패키지는 import 하지 않아도 된다.
		
		/* 메소드를 굳이 찾아 쓰지 않더라도 우리가 알고리즘을 짜서 기능하게 할 수 있다. */
		int input = -7;
