...
public class Application2 {
	public static void main(String[] args) {
		...
		/* Animal 클래스가 가지는 메소드를 오버라이딩한 메소드 호출 시 동적 바인딩을 활용할 수 있다. */
		/*
		 * 토끼 울어라! 호랑이 울어라! 이렇게 하는게 아니고
		 * 동물들 순차적으로 다 울어라! 이런 느낌으로 코딩을 구현할 수 있다.(동일한 메세지 송신 가능)
		 */
		...
		for(Animal animal : animals) {
			...
			/* 동물들아 너가 만약 토끼면 점프를 뛰고 호랑이면 물어라! 하는 느낌으로 코딩을 구현할 수 있다. */
