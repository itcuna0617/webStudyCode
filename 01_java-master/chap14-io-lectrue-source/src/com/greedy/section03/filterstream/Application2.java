...
public class Application2 {
	public static void main(String[] args) {
		 ...
		 * System.err (PrintStream): 콘솔로 데이터를 빨간 글씨로 출력한다.
		 * 
		 * 자주 사용되는 자원에 대해 미리 스트림을 생성해 두었기 때문에 별도로
		 * 개발자가 스트림을 생성하지 않아도 된다.
		 * 
		 * 이해정도만 하자.
		 */
		
		/* Scanner 같은 스트림 개념을 표준 입출력(입력)으로 만들어 보자. */
		...
		/* System.out.print 같은 스트림을 만들어 보자. */
		BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(System.out));
		
		try {
			bw.write("java oracle\n 화이팅!");
