/* 03. const(상수) */
/* let 키워드와 마찬가지로 블록 레벨 스코프를 가지며 중복 선언 방지 및 변수 호이스팅이 발생하지 않는 것처럼 동작한다. */
...
/* 
  일반적으로 상수의 이름은 대문자로 선언해서 상수임을 명확히 하며 여러 단어로 이루어진 경우 언더스코어(_)를 활용한 
