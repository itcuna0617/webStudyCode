/* 01. class basic syntax(클래스 기본 문법) */
...
console.log(Object.getOwnPropertyNames(student.__proto__));
console.log(Object.getOwnPropertyDescriptors(student.__proto__));

/* class를 활용해 만들어지는 객체도 결국 함수를 기반으로 만든 객체와 내부 원리가 동일하다. */
...
/* 프로토타입 객체에 있는 것은 객체를 for..in문 돌렸을 때 확인할 수 없다. */
class Test {
    constructor () {
        this.name = '홍길동'
    }
