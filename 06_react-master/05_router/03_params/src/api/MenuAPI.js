...
export function getMenuDetail(menuCode) {
    ...
    // console.log(typeof menuCode);        // pathVariable에서 꺼내온 값은 문자열이다.
...
export function searchMenu(searchMenuName) {
    // console.log('abc'.match('ab'));              // match 함수는 포함 여부에 따라 인수값이 포함되어 있으면 객체를 반환한다.
    // console.log(menus.filter(menu => menu.menuName.match(searchMenuName))); // 검색어를 포함한 menu객체들을 배열로 반환한다.
