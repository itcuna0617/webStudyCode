...
//    var mutableMap = mutableMapOf("key1" to 1, "key2" to 2)
    ...
    emptyMutableMap.put("key3", 4)      // 기존의 같은 키값을 지니 pair(쌍)을 덮어 쓴다.(수정)
    ...
    var valueFromKey = mutableMap["key"]
    println("muatbleMap get key1: $valueFromKey")
