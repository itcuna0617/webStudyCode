		...
		<div class="table-area">
			<table align="center">
				...
				<tr>
					...
					<td>조회수</td>
					<td><p><c:out value="${ requestScope.notice.count }"/></p></td>
				</tr>
				<tr>
					<td>내용</td>
					<td colspan="3">
			...
			<div align="center">
				...
				<c:if test="${ sessionScope.loginMember.role eq 'ADMIN' }">
					<button onclick="location.href='${ pageContext.servletContext.contextPath}/notice/update?no=${ requestScope.notice.no }'">
					수정하기
					</button>
				</c:if>
			</div>
