...
--ALTER USER C##JSP DEFAULT TABLESPACE USERS QUOTA UNLIMITED ON USERS;  -- TABLESPACE 확보
--ALTER USER C##JSP QUOTA 1024M ON SYSTEM;                             -- SYSTEM 공간 확보

-- 들어가 있는 회원은 id: admin, pwd: admin이다.
