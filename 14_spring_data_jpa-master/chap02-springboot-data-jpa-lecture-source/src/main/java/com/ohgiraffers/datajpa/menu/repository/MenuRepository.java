...
public interface MenuRepository extends JpaRepository<Menu, Integer> {
    ...
    int countByMenuPriceLessThanEqual(int price);

    List<Menu> findByMenuNameContaining(String searchValue, Pageable paging);

    List<Menu> findByMenuPriceLessThanEqual(int price, Pageable paging);
}
